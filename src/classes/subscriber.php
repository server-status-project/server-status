...
class Subscriber
{
  ...
  public function is_active_subscriber($token)
  {
    ...
    if ($row['active'] <> 1) {
      ...
      $time_start = ($time_end - (3600 * 2));
        // TODO - make this interval configurable via a config option
      $time_now = time();
  ...
  public function set_logged_in()
  {
    ...
    $_SESSION['subscriber_typeid'] = $this->typeID;
      // email
