...
class User
{
  ...
  public function render_user_settings()
  {
    ...
    ?>
    <div class="row user">
      <div class="col-md-2 offset-md-2"><img src="https://www.gravatar.com/avatar/<?php echo md5(strtolower(trim($this->email))); ?>?s=160" 
    ...
    <form action="<?php echo WEB_URL; ?>/admin/?do=user&amp;id=<?php echo $this->id; ?>" method="POST">
      <div class="row user">
        <div class="col-md-2 offset-md-2"><strong><?php echo _('Username'); ?></strong></div>
        <div class="col-md-6">
    <?php
    if ($this->id == $_SESSION['user'] || $user->get_rank() < 1) {
      ?>
    ...
    <form action="<?php echo WEB_URL; ?>/admin/?do=user&id=<?php echo $this->id; ?>" method="POST">
      <div class="row user">
        <div class="col-md-2 offset-md-2"><strong><?php echo _('Role'); ?></strong></div>
        <div class="col-md-6"><?php if ($user->get_rank() == 0 && $this->id != $_SESSION['user']) { ?> 
        <div class="input-group"><select class="form-select" name="permission">
          <?php
    ...
    <form action="<?php echo WEB_URL; ?>/admin/?do=user&amp;id=<?php echo $this->id; ?>" method="POST">
      <div class="row user">
        <div class="col-md-2 offset-md-2"><strong>Email</strong></div>
        <div class="col-md-6">
          <div class="input-group">
      ...
      ?>
    <div class="row user">
      <div class="col-md-2 offset-md-2"><strong><?php echo _('Email'); ?></strong></div>
      <div class="col-md-6">
    ...
    <form action="<?php echo WEB_URL; ?>/admin/?do=user" method="POST">
      <div class="row">
        <div class="col-md-2 offset-md-2"><strong><?php echo _('Password'); ?></strong></div>
        <div class="col-md-6">
