...
define("IMPRINT_URL", "policy.php"); //Default policy URL
...
if (isset($_POST['server']) && empty($message)) {
    ...
    if (empty($message)) {
        ...
        $imprint_url_conf = (!empty($_POST['imprint_url'])) ? htmlspecialchars($_POST['imprint_url'], ENT_QUOTES) : $_POST['url'] . "/policy.php";
        ...
        <form method="post" action=".">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row mt-3">
                        <span><?php echo _("If you alredy have an existing Imprint published, please provide the full Url to override the local policy definition. Leave blank to use the local definition"); ?></span>
                        <div class="col form-floating">
