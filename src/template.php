    ...
    if (!$admin) {
      ...
      if ('admin' == $str_url) {
        ...
        if (SUBSCRIBE_EMAIL || SUBSCRIBE_TELEGRAM) {
          ...
          $strSubsMenu = '<li class="nav-item dropdown">';
          ...
          if ((!isset($_SESSION['subscriber_valid'])) || false == $_SESSION['subscriber_valid']) {
            $strSubsMenu .= '<a class="nav-link dropdown-toggle" href="#" id="subscriberDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">' . _('Subscribe') . '</a>
                             <ul class="dropdown-menu" aria-labelledby="subscriberDropdown">';

            if (SUBSCRIBE_EMAIL) {
              $strSubsMenu .= '<li><a class="dropdown-item" href="?do=email_subscription&amp;new=1"><span class="glyphicon glyphicon-envelope"></span>&nbsp;' . _('Subscribe via email') . '</a></li>';
            }
      ...
      <footer id="footerwrap" class="sticky-bottom">
        <div class="container">
          <div class="row centered">
            ...
            <div class="col-md-4 text-right link-light"><a class="link-light" href="<?php echo IMPRINT_URL; ?>"><?php echo _("Imprint"); ?></a> - <a class="link-light" href="<?php echo POLICY_URL; ?>"><?php echo _("Privacy Policy"); ?></a></div>
          </div>
          <!--/row -->
        </div>
        <!--/container -->
