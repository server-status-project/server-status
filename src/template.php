...
class Template
{
  ...
  public static function render_header($page_name, $admin = false)
  {
    ...
    if (!$admin) {
      ...
      <head>
        ...
        <link rel="stylesheet" href="<?php echo WEB_URL;?>/css/bootstrap-icons.css">
          ...
          <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="ms-auto nav navbar-nav">
                <li class="nav-item"><a class="nav-link" href="<?php echo WEB_URL;?>/admin/"><?php echo _("Dashboard");?></a></li>
                <li class="nav-item"><a class="nav-link" href="<?php echo WEB_URL;?>/admin/?do=user"><?php printf(_("User (%s)"), $user->get_username());?></a></li>
                <li class="nav-item"><a class="nav-link" href="<?php echo WEB_URL;?>/admin/?do=settings"><?php echo _("Services & Users");?></a></li>
                <li class="nav-item"><a class="nav-link" href="<?php echo WEB_URL;?>/admin/?do=options"><?php echo _("Options");?></a></li>
                <li class="nav-item"><a class="nav-link" href="<?php echo WEB_URL;?>/admin/?do=logout"><?php echo _("Logout");?></a></li>
              </ul>
            </div>
          </div>
        </nav>
  ...
  */
  public static function render_footer($admin = false)
  {
    ...
    <div id="footerwrap">
      <div class="container">
        <div class="row centered">
          <div class="col-md-4 text-left"><a href="https://github.com/server-status-project/server-status/graphs/contributors" target="_blank">
          Copyright © <?php echo date("Y");?> Server Status Project Contributors </a>
    <?php if (strlen(COPYRIGHT_TEXT) > 1) {
    ...
    <?php if (defined('GOOGLE_RECAPTCHA') && GOOGLE_RECAPTCHA) {
